<?php
    global $wplogger;
    $wplogger->log('watch and listen.php is called');
?>
<?php global $is_ajax; 
		...
		<div class="clearer"></div>
         ...
         <div class="post" id="post-<?php the_ID(); ?>">
         	<div id="singlentry" class="<?php echo $wptouch_settings['style-text-justify']; ?>">
                <iframe width="634" height="460" src="http://www.youtube.com/embed/<?php echo wtf_get_youtube_id(get_post_meta(get_the_ID(), 'youtube_link', true))?>" frameborder="0" allowfullscreen></iframe>
